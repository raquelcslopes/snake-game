...
public final class Field {
    ...
    public static void init(int width, int height) { //configura a tela
    ...
    public static void drawGameOver () {
        screen.putString(45,12, DEAD_SNAKE, Terminal.Color.RED, Terminal.Color.BLACK, ScreenCharacterStyle.Blinking);
    }
